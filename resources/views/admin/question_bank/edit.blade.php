    ...
    <div class="col-lg-8">
        <div class="card p-4">
            <div class="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                    <h4 class="mb-0 fw-bold">Edit Global Question</h4>
                    <p class="text-muted mb-0" style="font-size: .875rem;">Modify coordinates, correct answers, or options for this question in the global repository.</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.question-bank.update', $question) }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="question_text" class="form-control" rows="3" placeholder="Enter question description..." required>{{ old('question_text', $question->question_text) }}</textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="type" id="typeSelect" class="form-select" required>
                            ...
                            <option value="short_answer" {{ old('type', $question->type) === 'short_answer' ? 'selected' : '' }}>Short Answer / Subjective</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="topic" class="form-control" placeholder="e.g. Aqidah, Feqah, Akhlak" value="{{ old('topic', $question->topic) }}" required>
                    </div>
                        ...
                        <div class="card bg-light p-3 border-0">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="options[a]" class="form-control" placeholder="Option A value" value="{{ old('options.a', $question->options['a'] ?? '') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Option B</label>
                                    <input type="text" name="options[b]" class="form-control" placeholder="Option B value" value="{{ old('options.b', $question->options['b'] ?? '') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Option C</label>
                                    <input type="text" name="options[c]" class="form-control" placeholder="Option C value" value="{{ old('options.c', $question->options['c'] ?? '') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Option D</label>
                                    <input type="text" name="options[d]" class="form-control" placeholder="Option D value" value="{{ old('options.d', $question->options['d'] ?? '') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div id="correctAnswerShortGroup" style="display:none;">
                            <input type="text" name="correct_answer_short" id="correctAnswerShort" class="form-control" placeholder="Enter correct textual answer" value="{{ old('correct_answer', $question->correct_answer) }}">
                        </div>
                        <input type="hidden" name="correct_answer" id="correctAnswerHidden" value="{{ old('correct_answer', $question->correct_answer) }}">
                    </div>
