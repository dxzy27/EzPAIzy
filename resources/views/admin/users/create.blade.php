    ...
    <div class="col-lg-8">
        <div class="card p-4">
            <div class="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                    <h4 class="mb-0 fw-bold">Create New User Account</h4>
                    <p class="text-muted mb-0" style="font-size: .875rem;">Register a new teacher or student account inside the EzPAIzy platform.</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" id="createUserForm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone_number" class="form-control" placeholder="e.g. +60123456789" value="{{ old('phone_number') }}">
                    </div>

                    {{-- Address --}}
                    <div class="col-12">
                        <label class="form-label small fw-bold">Residential Address</label>
                        <textarea name="address" class="form-control" rows="3" placeholder="Enter home address...">{{ old('address') }}</textarea>
                    </div>

                    <div class="col-12 text-end mt-4">
                        <a href="{{ route('admin.users.index') }}" class="btn btn-light me-2">Cancel</a>
                        <button type="submit" class="btn btn-primary px-4">Register Account</button>
                    </div>
                </div>
            </form>
        </div>
