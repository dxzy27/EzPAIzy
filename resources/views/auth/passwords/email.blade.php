...
<div class="page-wrap">
    <div class="auth-card">
        ...
        <h1 class="card-heading text-center">
            Reset Your <span class="accent">Password</span>
        </h1>
        <p class="auth-subtitle text-center mb-4">Enter your email to receive a password reset link</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('login') }}" class="accent-link" style="font-size:.85rem;">Back to login</a>
            </div>
        </form>
    </div>
</div>
