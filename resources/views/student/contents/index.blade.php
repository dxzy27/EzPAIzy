    ...
    <div class="row mb-5">
        @foreach($topics as $topic)
            <div class="col-md-2 mb-3">
                <a href="{{ route('student.contents.folder', ['topic' => $topic->name]) }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm border-0 bg-light text-dark folder-card">
    ...
    @else
        <div class="row mt-4">
            <div class="col-md-12 text-center py-5 text-muted bg-white rounded shadow-sm">
                ...
                <p class="small text-muted mb-0">Your instructor hasn't created any folders for other materials yet.</p>
            </div>
        </div>
    @endif
