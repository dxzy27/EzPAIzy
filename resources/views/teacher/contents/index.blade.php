...
<div class="container-fluid px-4 py-4" style="max-width: 1040px; margin: 0 auto;">
        ...
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('teacher.contents.create') }}" class="btn btn-primary fw-semibold px-3" style="border-radius: 10px; font-size: 0.9rem;">
    ...
    <div class="row g-3 mb-5">
        @foreach($topics as $topic)
            <div class="col-sm-6 col-md-3 mb-3 position-relative group-action topic-folder-col" data-topic-name="{{ strtolower($topic->name) }}">
                ...
                <form action="{{ route('teacher.topics.destroy', $topic) }}" method="POST" class="position-absolute top-0 end-0 mt-2 me-3" onsubmit="return confirm('Delete this folder? Contents will remain but lose their folder assignment.');">
                    @csrf
                    @method('DELETE')
    ...
    <div class="card border-0 shadow-sm text-center py-5" style="border-radius:16px;">
        <div class="text-muted">
            ...
            <p class="mb-3">Create a folder to start organizing learning materials.</p>
                ...
                <form action="{{ route('teacher.topics.store') }}" method="POST">
                    ...
                    <div class="modal-body py-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" required placeholder="e.g. Chapter 1 Notes" style="border-radius: 10px;">
                        </div>
                    </div>
