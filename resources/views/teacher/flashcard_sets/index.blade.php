    ...
    <div class="row mb-4">
        @foreach($topics as $topic)
            <div class="col-md-2 mb-3 position-relative group-action">
                ...
                <form action="{{ route('teacher.topics.destroy', $topic) }}" method="POST" class="position-absolute top-0 end-0 mt-1 me-2" onsubmit="return confirm('Delete this folder? Sets will remain but lose their folder assignment.');">
                    @csrf
                    @method('DELETE')
