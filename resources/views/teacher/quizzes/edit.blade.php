        ...
        <div class="card-body p-4">
                    <form action="{{ route('teacher.quizzes.update', ['topic' => $quiz->topic, 'difficulty' => $quiz->difficulty]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg fw-semibold @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $quiz->title ?? '') }}" placeholder="Enter Quiz Title" required style="border-radius: 10px; font-size: 1.05rem;">
                            @error('title')
