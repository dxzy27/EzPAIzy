                ...
                <tbody>
                    @forelse ($students as $student)
                        <tr>
                            ...
                            <td>
                                <span class="badge fw-bold px-2 py-1" style="border-radius: 6px; display: inline-flex; align-items: center; justify-content: center; min-width: 24px; min-height: 24px; background-color: #3b82f6 !important; color: #ffffff !important;">{{ $student->active_quizzes_count ?? 0 }}</span>
                            </td>
